...
public class TicketView extends View {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            mScallopRadius = typedArray.getDimensionPixelSize(R.styleable.TicketView_scallopRadius, OperaUtils.dpToPx(20f, getContext()));
            ...
            mBorderWidth = typedArray.getDimensionPixelSize(R.styleable.TicketView_borderWidth, OperaUtils.dpToPx(2f, getContext()));
            ...
            mDividerWidth = typedArray.getDimensionPixelSize(R.styleable.TicketView_dividerWidth, OperaUtils.dpToPx(2f, getContext()));
            mDividerColor = typedArray.getColor(R.styleable.TicketView_dividerColor, getResources().getColor(android.R.color.darker_gray));
            mDividerDashLength = typedArray.getDimensionPixelSize(R.styleable.TicketView_dividerDashLength, OperaUtils.dpToPx(8f, getContext()));
            mDividerDashGap = typedArray.getDimensionPixelSize(R.styleable.TicketView_dividerDashGap, OperaUtils.dpToPx(4f, getContext()));
            mCornerType = typedArray.getInt(R.styleable.TicketView_cornerType, CornerType.NORMAL);
            mCornerRadius = typedArray.getDimensionPixelSize(R.styleable.TicketView_cornerRadius, OperaUtils.dpToPx(4f, getContext()));
            mDividerPadding = typedArray.getDimensionPixelSize(R.styleable.TicketView_dividerPadding, OperaUtils.dpToPx(10f, getContext()));
            float elevation = 0f;
    ...
    private void setShadowBlurRadius(float elevation) {
        ...
        float maxElevation = OperaUtils.dpToPx(24f, getContext());
