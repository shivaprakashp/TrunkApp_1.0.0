...
import com.opera.app.dialogues.SearchableListDialog;

import java.util.ArrayList;
import java.util.List;

public class CustomSpinner extends android.support.v7.widget.AppCompatSpinner implements View.OnTouchListener,
