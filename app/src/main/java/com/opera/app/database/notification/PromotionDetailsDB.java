...
public class PromotionDetailsDB {
    ...
    public static final String CREATE_TABLE_PROMOTION =
            "CREATE TABLE " + TABLE_PROMOTION_DETAILS + "(" + NOTIFICATION_TITLE + " INTEGER,"
    ...
    //insterting data
    public void insertPromotions(ArrayList<Notification> mNotification) {
    ...
    public ArrayList<Notification> fetchPromotionDetails() {
